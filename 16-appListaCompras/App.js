        ...
        borderColor: "#FFEF78",
          ...
          <View>
            <TouchableOpacity onPress={() => {deleteProduto(item.id)}}>
              <Fontisto name='shopping-basket-remove' size={25} style={{color: "#A8E7E9"}}/>
            </TouchableOpacity>
          </View>
      </View>
    );
  ...
  return (
    <View style={{paddingTop: 20}}>
      ...
      <Text style={styles.titulo}>
        Lista de compras <Fontisto name='shopping-store' size={25} style={{color: "white"}}/>
      </Text>
    ...
    <View style={{flexDirection: "row", justifyContent: "center", alignItems: "center", backgroundColor: '#FFEF78'}}>
      ...
      <View style={{alignItems: 'center', marginTop: 20, marginBottom: 20}}>
        <TouchableOpacity style={{
            ...
            >
            <Fontisto name='shopping-basket-add' size={30} style={{color: "#EB92BE"}} />
          </TouchableOpacity>
      </View>
    </View>
