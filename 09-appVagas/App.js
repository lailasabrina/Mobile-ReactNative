...
class App extends Component{
  ...
  constructor(props) {
    ...
    this.state = {
      feed:[
        {id: 1, titulo: 'Programador PHP', salario: 'R$ 1.800,00 a R$ 2.100,00 (Bruto mensal)', descricao: '• Área e especialização profissional: Informática, TI, Telecomunicações - Programador / Desenvolvedor \n• Local de trabalho: São Paulo, SP \n• Criar, desenvolver e efetuar manutenção em plataformas de e-commerce', contato: 'engecommerce.com.br'},
        {id: 2, titulo: 'Desenvolvedor Full Stack', salario: 'R$ 2.800,00 a R$ 3.000,00 (Bruto mensal)', descricao: '• Área e especialização profissional: Informática, TI, Telecomunicações - Programador / Desenvolvedor \n• Local de trabalho: São Paulo, SP \n• Necessário experiência com design responsivo, versionamento de codigo em Git, programação em NET FRAWORK-C emgeral e WebAPI. Conhecimento da plataforma windows, conhecimento geral de programações web e consumo de API ( Rest e HTTP), programação Desktp, linguagem SQL, banco de dados relacional. Conhecimento em Cloud- AWS.', contato: 'helpfulrh.com.br'},
        {id: 3, titulo: 'Desenvolvedor JAVA', salario: 'R$ 10.000,00 a R$ 15.000,00 (Bruto mensal)', descricao: '• Área e especialização profissional: Informática, TI, Telecomunicações - Programador / Desenvolvedor \n• Local de trabalho: São Paulo, SP \n• Desenvolvimento de projetos em Java, onde deverá analisar, desenvolver e dar manutenções em sistemas java, lendo modelos entidade relacionamento e produzir documentos dos projetos realizados.', contato: 'www.mediarte.com.br'},
        {id: 4, titulo: 'Desenvolvedor - Pl', salario: 'A combinar', descricao: '• Área e especialização profissional: Informática, TI, Telecomunicações - Programador / Desenvolvedor \n• Local de trabalho: São Paulo, SP \n• Empresa de Tecnologia Especializada em Data Science, Web Programming e Business Analytics busca Desenvolvedor/Programador PL para atuar Home Office e fazer parte de seu Squad.', contato: 'www.rhf.com.br'},
        {id: 5, titulo: 'Desenvolvedor Java', salario: 'A combinar', descricao: '• Área e especialização profissional: Informática, TI, Telecomunicações - Programador / Desenvolvedor \n• Local de trabalho: São Bernardo do Campo, SP \n• Experiência em desenvolvimento e implantação Java (Web); \n• Experiência no uso dos frameworks: Spring MVC, Apache Struts, SpringBoot; \n• Experiência no uso de pelo menos um dos frameworks da camada de apresentação : JSF, Angular, Bootstrap, JSP/JSTL/TagLib; \n• Solidos conhecimentos em HTML5, (S)CSS, JQuery;', contato: 'www.dxc.com'},
        {id: 6, titulo: 'Desenvolvedor Web', salario: 'R$ 10.000,00 a R$ 12.000,00 (Bruto mensal)', descricao: '• Área e especialização profissional: Informática, TI, Telecomunicações - Programador / Desenvolvedor \n• Local de trabalho: São Paulo, SP \n• Escrever códigos compatíveis com padrões, incluindo teste/depuração em várias plataformas; \n• Projetar e implementar componentes do sistema;', contato: '(11) 2796-5443'},
      ]
    }
  }
